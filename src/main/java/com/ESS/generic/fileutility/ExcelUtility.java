...
public class ExcelUtility {
	...
	{
	FileInputStream fis=new FileInputStream("./src/main/resources/ESSTestdata.xlsx");
	...
	FileOutputStream fos=new FileOutputStream("./src/main/resources/ESSTestdata.xlsx");
	wb.write(fos);
	wb.close();
	}
